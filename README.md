...
Os arquivos menu.js e config.js são responsáveis por criar a dinâmica de classes do jogo e por configurar o comportamento da engine, respectivamente.
...
(exemplo de comandos de movimento e seus keycodes do teclado para os players 1 e 2)
